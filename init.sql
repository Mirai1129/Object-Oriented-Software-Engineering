CREATE DATABASE  IF NOT EXISTS `Participation` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `Participation`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: Participation
-- ------------------------------------------------------
...
CREATE TABLE `ParticipationGrade` (
  ...
  CONSTRAINT `ParticipationGrade_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `Student` (`id`)
...
INSERT INTO `ParticipationGrade` VALUES (0,'3137','B11023024',100.00,'2024-11-04',NULL),(6,'3137','B11023024',99.00,'2024-12-10','2024-12-10 19:40:49');
...
INSERT INTO `Student` VALUES ('B11023024','陳仁傑');
...
INSERT INTO `Teacher` VALUES ('T12345678','OO','黃昭義');
...
INSERT INTO `User` VALUES ('B11023024','$2b$12$z17x/lP3YmIFLkcEiMEiluCvTePELWUgamX4kVZ29O2eCyJMJmRge',0),('T12345678','$2b$12$z17x/lP3YmIFLkcEiMEiluCvTePELWUgamX4kVZ29O2eCyJMJmRge',1);
...
-- Dump completed on 2024-12-10 20:09:22
CREATE DATABASE  IF NOT EXISTS `Rollcall` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `Rollcall`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
...
-- Dump completed on 2024-12-10 20:09:23
